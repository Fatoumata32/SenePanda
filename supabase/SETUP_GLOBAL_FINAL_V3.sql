-- ========================================
-- SETUP GLOBAL FINAL V3 - AVEC plan_type
-- ========================================
-- Ce script corrige TOUT automatiquement
-- Inclut plan_type et toutes les colonnes nécessaires
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '========================================';
  RAISE NOTICE '🚀 SETUP GLOBAL V3 - SYNC AUTO';
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
END $$;
...
-- 1.3 Mettre à jour les plans existants (AVEC plan_type)
DO $$
BEGIN
  -- Plan Starter
  ...
  ELSE
    ...
    VALUES ('Starter', 'Plan de démarrage', 'basic', 5000.00, 'FCFA', 30, 10, 1, '[\"Jusqu''à 10 produits\", \"1 boutique\"]'::jsonb, true);
  ...
  ELSE
    INSERT INTO subscription_plans (name, description, plan_type, price, currency, duration_days, max_products, max_shops, features, is_active)
    VALUES ('Premium', 'Plan complet', 'premium', 15000.00, 'FCFA', 30, NULL, 3, '[\"Produits illimités\", \"3 boutiques\"]'::jsonb, true);
  ...
  ELSE
    INSERT INTO subscription_plans (name, description, plan_type, price, currency, duration_days, max_products, max_shops, features, is_active)
    VALUES ('Business', 'Solution professionnelle', 'business', 50000.00, 'FCFA', 30, NULL, 10, '[\"Tout Premium\", \"10 boutiques\"]'::jsonb, true);
